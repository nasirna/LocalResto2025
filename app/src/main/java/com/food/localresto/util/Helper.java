...
public class Helper {
    ...
    public static final String PUBLIC_FOLDER = "http://ptnasirna.000webhostapp.com/public/";
    ...
    public static final String PATH_TO_ALL_MENU_ITEM = PUBLIC_FOLDER + "mobileallmenuitem";
    ...
    //nasir
    public static final String PATH_TO_ADD_MENU_CAT = PUBLIC_FOLDER + "mobileaddmenucat";
    public static final String PATH_TO_EDIT_MENU_CAT = PUBLIC_FOLDER + "mobileeditmenucat";
    public static final String PATH_TO_DELETE_MENU_CAT = PUBLIC_FOLDER + "mobiledeletemenucat";

    public static final String PATH_TO_ADD_MENU_ITEM = PUBLIC_FOLDER + "mobileaddmenuitem";
    public static final String PATH_TO_EDIT_MENU_ITEM = PUBLIC_FOLDER + "mobileeditmenuitem";
    public static final String PATH_TO_DELETE_MENU_ITEM = PUBLIC_FOLDER + "mobiledelmenuitem";
    ...
    public static String dateFormatting2(String dateInString){
        SimpleDateFormat sdfDestination = new SimpleDateFormat("yyyy-MM-dd", Locale.ENGLISH);
        Date stringDate = null;
        try {
            stringDate = sdfDestination.parse(dateInString);
    ...
    public static String dateFormattingJam(String dateInString){
        ...
        return new SimpleDateFormat("HH:mm:ss", Locale.ENGLISH).format(stringDate);
    }
