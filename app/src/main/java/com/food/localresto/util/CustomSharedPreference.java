...
public class CustomSharedPreference {
    ...
    //Save Cart Information
    public void updateListMenuItems(String cartItem){
        sharedPref.edit().putString(Helper.MENU_ITEM, cartItem).apply();
    }

    public String getListMenuItems(){
        return sharedPref.getString(Helper.MENU_ITEM, "");
    }
}
